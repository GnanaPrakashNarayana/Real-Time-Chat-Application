...
export const useGroupStore = create((set, get) => ({
  ...
  smartReplies: [], // Added for smart replies
  isLoadingSmartReplies: false, // Added for smart replies
  ...
  subscribeToGroupMessages: () => {
    ...
    socket.on("newGroupMessage", (data) => {
      ...
      if (selectedGroup && selectedGroup._id === group._id) {
        ...
        // Generate smart replies when receiving a new message from others
        if (message.text && message.senderId._id !== useAuthStore.getState().authUser._id) {
